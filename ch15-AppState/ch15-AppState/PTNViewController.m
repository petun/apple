...
-(void)applicationDidEnterBackground {
    ...
    // таким блоком мы говорим системе: что нам нужно больше времени для завершения операции
    ...
    // если система дает нам время для завершения задания
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        // говорим системе что мы закончили
        [app endBackgroundTask:taskId];
    });
}
